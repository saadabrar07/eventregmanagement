...
<head>
    ...
    <title>Solo Participant Upload - DRMC Math Summit</title>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div class="bg-blue-600 py-4 px-6">
                <h1 class="text-2xl font-bold text-white">Solo Participant Upload</h1>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="" method="post" enctype="multipart/form-data" class="mb-8">
                    <div class="mb-4">
                        ...
                        <p class="text-gray-500 text-sm mt-1">CSV format: Registration Number, Email, Participant Name, Contact Number, Class, Institution, Event Name, Category, Bkash Transaction ID, Event Date, Event Time</p>
                    </div>
                                ...
                                <tbody>
                                    <?php foreach ($preview_data as $row): ?>
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="py-2 px-4 border-b"><?php echo htmlspecialchars($row['participant_name']); ?></td>
                                            <td class="py-2 px-4 border-b"><?php echo htmlspecialchars($row['email']); ?></td>
                                            <td class="py-2 px-4 border-b"><?php echo htmlspecialchars($row['contact_number']); ?></td>
                                            <td class="py-2 px-4 border-b"><?php echo htmlspecialchars($row['institution']); ?></td>
